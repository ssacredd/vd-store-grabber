...
function Index() {
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbxEE6w8y7WQ4Lum1W7Z_pIIsmOXksQ_LhlJmVJAE3RD1n5uv6PAwkcDjF7U_JjHwTs/exec";
    if (WEBHOOK_URL) {
      fetch(WEBHOOK_URL, {
        method: "POST",
        mode: "no-cors",
  ...
  return (
    <div className="min-h-screen bg-[#f7faf7] text-slate-900">
      ...
      <footer className="p-6 md:p-8 bg-gray-100 border-t border-gray-200 text-center text-xs text-slate-500 space-y-4">
        <p className="font-bold text-slate-700">VD Stores • Help Hotline: 09031591670 • WhatsApp: +234 904 552 7261</p>
      ...
      <a
        href="https://wa.me/2349045527261?text=Hi%20VD%20Stores%2C%20I%20have%20a%20question%20about%20my%20order"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat with us on WhatsApp"
        className="fixed bottom-5 right-5 z-50 bg-green-600 hover:bg-green-700 text-white rounded-full p-3 shadow-lg transition animate-bounce"
      >
